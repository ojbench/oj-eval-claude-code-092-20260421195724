...
def main():
    ...
    submit_parser.add_argument("--file", type=str, required=True, help="Source code file")
    submit_parser.add_argument("--language", type=str, default="C++", help="Programming language")
